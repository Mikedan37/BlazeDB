...
/// Start a live query for open todos using an existing blazedb_bridge_open handle.
/// The live query borrows the database handle; stop does not close the owning session.
