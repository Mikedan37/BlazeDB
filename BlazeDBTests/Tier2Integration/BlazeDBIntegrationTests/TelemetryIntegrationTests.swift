...
final class TelemetryIntegrationTests: XCTestCase {
    ...
    func testTelemetry_ErrorTracking() async throws {
        ...
        let db = try BlazeDBClient(name: "ErrorTest", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testTelemetry_UsageAnalytics() async throws {
        ...
        let db = try BlazeDBClient(name: "Analytics", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testTelemetry_OptimizationValidation() async throws {
        ...
        let db = try BlazeDBClient(name: "Optimize", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testTelemetry_HighLoadScenario() async throws {
        ...
        let db = try BlazeDBClient(name: "HighLoad", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testTelemetry_MultiDatabaseScenario() async throws {
        ...
        let db1 = try BlazeDBClient(name: "DB1", fileURL: db1URL, password: "TestPass-123456!")
        let db2 = try BlazeDBClient(name: "DB2", fileURL: db2URL, password: "TestPass-123456!")
...
#else
final class TelemetryIntegrationTests: XCTestCase {
    func testTelemetryUnavailableInCoreBuild() {
        XCTAssertTrue(true, "Telemetry integration scenarios require distributed build")
    }
}
#endif
