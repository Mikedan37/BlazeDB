...
final class ContractAPIStabilityTests: XCTestCase {
    ...
    func testContract_CRUDOperations() async throws {
        ...
        let db = try BlazeDBClient(name: "CRUD", fileURL: dbURL, password: "Contract-123Aa!")
    ...
    func testContract_QueryBuilderAPI() async throws {
        ...
        let db = try BlazeDBClient(name: "QueryContract", fileURL: dbURL, password: "Contract-123Aa!")
        ...
        let db2 = try BlazeDBClient(name: "Join", fileURL: db2URL, password: "Contract-123Aa!")
        ...
        let joined = try db.join(with: db2, on: "value", equals: "ref", type: .inner)
    ...
    func testContract_TypeSafeAPI() async throws {
        ...
        let db = try BlazeDBClient(name: "TypeSafe", fileURL: dbURL, password: "Contract-123Aa!")
    ...
    func testContract_TransactionAPI() async throws {
        ...
        let db = try BlazeDBClient(name: "TxnContract", fileURL: dbURL, password: "Contract-123Aa!")
    ...
    func testContract_SearchAPI() async throws {
        ...
        let db = try BlazeDBClient(name: "SearchContract", fileURL: dbURL, password: "Contract-123Aa!")
        ...
        let results = try db.collection.search(
            query: "Searchable",
            in: ["title"]
        )
    ...
    func testBackwardCompatibility_V1CodeReadsV2Database() async throws {
        ...
        var db: BlazeDBClient? = try BlazeDBClient(name: "Compat", fileURL: dbURL, password: "Compat-123Aa!")
