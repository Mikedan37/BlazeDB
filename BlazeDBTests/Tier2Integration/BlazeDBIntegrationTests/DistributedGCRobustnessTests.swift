...
final class DistributedGCRobustnessTests: XCTestCase {
    ...
    override func setUp() {
        ...
        db1 = try! BlazeDBClient(name: "DB1", fileURL: url1, password: "TestPass1234!")
        db2 = try! BlazeDBClient(name: "DB2", fileURL: url2, password: "TestPass1234!")
        db3 = try! BlazeDBClient(name: "DB3", fileURL: url3, password: "TestPass1234!")
    }
...
#else
final class DistributedGCRobustnessTests: XCTestCase {
    func testDistributedGCRobustnessUnavailableInCoreBuild() {
        XCTAssertTrue(true, "Distributed GC robustness tests require distributed build")
    }
}
#endif
