...
final class SchemaForeignKeyIntegrationTests: XCTestCase {
    ...
    func testIntegration_BugTrackerWithSchema() throws {
        ...
        let db = try BlazeDBClient(name: "AshPile", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testIntegration_MultiCollectionWithForeignKeys() throws {
        ...
        let usersDB = try BlazeDBClient(name: "users", fileURL: usersURL, password: "TestPass-123456!")
        let bugsDB = try BlazeDBClient(name: "bugs", fileURL: bugsURL, password: "TestPass-123456!")
        let commentsDB = try BlazeDBClient(name: "comments", fileURL: commentsURL, password: "TestPass-123456!")
    ...
    func testIntegration_SchemaWithTelemetry() async throws {
        ...
        let db = try BlazeDBClient(name: "SchemaTest", fileURL: dbURL, password: "TestPass-123456!")
        ...
        XCTAssertEqual(count, 5, "Valid inserts should still succeed in core build")
        #endif
    ...
    func testIntegration_MigrationWithSchema() throws {
        ...
        var db: BlazeDBClient? = try BlazeDBClient(name: "Migration", fileURL: dbURL, password: "TestPass-123456!")
        ...
        // Close and reopen
        db = nil
        db = try BlazeDBClient(name: "Migration", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testIntegration_ComplexValidation() throws {
        ...
        let db = try BlazeDBClient(name: "Complex", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testIntegration_EcommerceWithRelationships() throws {
        ...
        let usersDB = try BlazeDBClient(name: "users", fileURL: usersURL, password: "TestPass-123456!")
        let ordersDB = try BlazeDBClient(name: "orders", fileURL: ordersURL, password: "TestPass-123456!")
        let itemsDB = try BlazeDBClient(name: "items", fileURL: itemsURL, password: "TestPass-123456!")
        ...
        // Verify structure
        XCTAssertEqual(try usersDB.count(), 1)
        XCTAssertEqual(try ordersDB.count(), 1)
        XCTAssertEqual(try itemsDB.count(), 2)
        ...
        XCTAssertEqual(try itemsDB.count(), 0, "Items should be cascade deleted")
    ...
    func testPerformance_SchemaValidation() throws {
        ...
        let db = try BlazeDBClient(name: "PerfTest", fileURL: dbURL, password: "TestPass-123456!")
