...
final class MigrationVersioningTests: XCTestCase {
    ...
    func testMigration_ThreeGenerationsOfSchema() async throws {
        ...
        var db: BlazeDBClient? = try BlazeDBClient(name: "MigrationApp", fileURL: dbURL, password: "Migration-123Aa!")
        ...
        db = try BlazeDBClient(name: "MigrationApp", fileURL: dbURL, password: "Migration-123Aa!")
    ...
    func testBackwardCompatibility_OldCodeReadsNewSchema() async throws {
        ...
        var db: BlazeDBClient? = try BlazeDBClient(name: "BackCompat", fileURL: dbURL, password: "Compat-123Aa!")
    ...
    func testForwardCompatibility_NewCodeReadsOldSchema() async throws {
        ...
        var db: BlazeDBClient? = try BlazeDBClient(name: "ForwardCompat", fileURL: dbURL, password: "Compat-123Aa!")
    ...
    func testMigration_ZeroDowntime() async throws {
        ...
        let db = try BlazeDBClient(name: "ZeroDowntime", fileURL: dbURL, password: "Zero-123Aa!X")
