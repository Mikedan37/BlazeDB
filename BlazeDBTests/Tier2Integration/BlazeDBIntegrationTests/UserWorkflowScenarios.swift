...
final class UserWorkflowScenarios: XCTestCase {
    ...
    func testScenario_MobileAppOfflineSupport() async throws {
        ...
        var db: BlazeDBClient? = try BlazeDBClient(name: "MobileApp", fileURL: dbURL, password: "Mobile-Secure-123!")
        ...
        try await db?.close()
        db = nil
        db = try BlazeDBClient(name: "MobileApp", fileURL: dbURL, password: "Mobile-Secure-123!")
    ...
    func testScenario_DataScientistCSVImport() async throws {
        ...
        let db = try BlazeDBClient(name: "DataScience", fileURL: dbURL, password: "Analysis-Secure-123!")
    ...
    func testScenario_RapidPrototypeMVP() async throws {
        ...
        var db: BlazeDBClient? = try BlazeDBClient(name: "StartupMVP", fileURL: dbURL, password: "Mvp-Secure-2025!")
        ...
        db = try BlazeDBClient(name: "StartupMVP", fileURL: dbURL, password: "Mvp-Secure-2025!")
