...
final class BlazeBinaryIntegrationTests: XCTestCase {
    ...
    func testIntegration_BlazeBinaryWithEncryption() throws {
        ...
        let db = try BlazeDBClient(name: "Encrypted", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testIntegration_BlazeBinaryWithRLS() throws {
        ...
        let db = try BlazeDBClient(name: "RLS", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testIntegration_BlazeBinaryWithGC() async throws {
        ...
        let db = try BlazeDBClient(name: "GC", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testIntegration_AllFeatures_BlazeBinary() async throws {
        ...
        #else
        print("  📊 Telemetry summary unavailable in core build (stub)")
        #endif
    ...
    func testIntegration_JSONtoBlazeBinaryMigration() throws {
        ...
        let db1 = try BlazeDBClient(name: "Migration", fileURL: dbURL, password: "TestPass-123456!")
        ...
        let db2 = try BlazeDBClient(name: "Migration", fileURL: dbURL, password: "TestPass-123456!")
