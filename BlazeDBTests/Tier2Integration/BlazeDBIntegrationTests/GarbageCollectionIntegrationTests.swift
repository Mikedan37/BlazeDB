...
private actor GCChurnCounter {
    var insertCount = 0, deleteCount = 0
    func incInsert() { insertCount += 1 }
    func incDelete() { deleteCount += 1 }
    func get() -> (Int, Int) { (insertCount, deleteCount) }
}
...
final class GarbageCollectionIntegrationTests: XCTestCase {
    ...
    func testGC_BugTrackerArchiveWorkflow() async throws {
        ...
        let db = try BlazeDBClient(name: "BugTracker", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testGC_MetricsDatabaseWithRetention() async throws {
        ...
        let db = try BlazeDBClient(name: "Metrics", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testGC_CacheLayerWithExpiration() async throws {
        ...
        let db = try BlazeDBClient(name: "Cache", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testGC_RapidChurnStress() async throws {
        ...
        let db = try BlazeDBClient(name: "ChurnTest", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testGC_WithTransactions() async throws {
        ...
        let db = try BlazeDBClient(name: "GCTxn", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testGC_WithIndexesAndSearch() async throws {
        ...
        let db = try BlazeDBClient(name: "GCIndexes", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testGC_WithVacuumAndBackup() async throws {
        ...
        let db = try BlazeDBClient(name: "GCBackup", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testGC_AutoVacuumTriggersCorrectly() async throws {
        ...
        let db = try BlazeDBClient(name: "AutoGC", fileURL: dbURL, password: "TestPass-123456!")
    ...
    func testGC_WithConcurrentOperations() async throws {
        ...
        let db = try BlazeDBClient(name: "GCConcurrent", fileURL: dbURL, password: "TestPass-123456!")
        
        // Pre-populate
        _ = try await db.insertMany((0..<100).map { i in BlazeDataRecord(["value": .int(i)]) })
        
        let counter = GCChurnCounter()
        ...
        let (insertCount, deleteCount) = await counter.get()
    ...
    func testGC_ThroughCrashRecovery() async throws {
        ...
        var db: BlazeDBClient? = try BlazeDBClient(name: "GCCrash", fileURL: dbURL, password: "TestPass-123456!")
        ...
        // Recovery
        db = try BlazeDBClient(name: "GCCrash", fileURL: dbURL, password: "TestPass-123456!")
        ...
        measure(metrics: [XCTClockMetric(), XCTMemoryMetric()]) {
            Task {
                do {
                    ...
                    let db = try BlazeDBClient(name: "GCPerf", fileURL: dbURL, password: "TestPass-123456!")
