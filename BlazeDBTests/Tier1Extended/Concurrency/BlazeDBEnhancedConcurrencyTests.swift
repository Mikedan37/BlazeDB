...
final class BlazeDBEnhancedConcurrencyTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        db = try BlazeDBClient(name: "ConcurrencyTest", fileURL: try requireFixture(tempURL), password: "TestPassword-123!")
    }
    ...
    func testCounterRaceCondition() throws {
        ...
        // Verify final count
        let final = try requireFixture(db).fetch(id: counterID)
