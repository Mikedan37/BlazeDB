...
final class TopologyTests: XCTestCase {
    ...
    func testRegisterDatabase() async throws {
        ...
        let bugsDB = try BlazeDBClient(name: "Bugs", fileURL: bugsURL, password: "SecurePass-ABC123!")
    ...
    func testRegisterMultipleDatabases() async throws {
        ...
        let bugsDB = try BlazeDBClient(name: "Bugs", fileURL: bugsURL, password: "SecurePass-ABC123!")
        let usersDB = try BlazeDBClient(name: "Users", fileURL: try requireFixture(usersURL), password: "SecurePass-ABC123!")
    ...
    func testLocalConnectionReadOnly() async throws {
        ...
        let bugsDB = try BlazeDBClient(name: "Bugs", fileURL: bugsURL, password: "SecurePass-ABC123!")
        let dashboardDB = try BlazeDBClient(name: "Dashboard", fileURL: dashboardURL, password: "SecurePass-ABC123!")
        
        // Insert bug in bugs DB
        let bugId = try await requireFixture(bugsDB).insert(BlazeDataRecord([
