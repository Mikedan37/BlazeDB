...
final class GarbageCollectionEdgeTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        db = try BlazeDBClient(name: "GCEdgeTest", fileURL: dbURL, password: "SecureTestDB-456!")
    }
    ...
    func testGC_InsertAfterFullVacuum() async throws {
        ...
        let emptyCount = try await try db.count()
        ...
        let afterInsert = try await try db.count()
