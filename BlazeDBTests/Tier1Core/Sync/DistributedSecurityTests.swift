...
final class DistributedSecurityTests: XCTestCase {
    ...
    func testSyncEngine_InvalidRemoteOperation_DoesNotMutateState() async throws {
        ...
        let fetched = try db2.fetch(id: targetRecordID)
    ...
    func testSyncEngine_MixedBatchWithInvalidOperation_RejectsEntireBatch() async throws {
        ...
        XCTAssertNil(try db2.fetch(id: validLooking1.recordId), "Batch reject must prevent op1 mutation")
        XCTAssertNil(try db2.fetch(id: invalid.recordId), "Batch reject must prevent invalid op mutation")
        XCTAssertNil(try db2.fetch(id: validLooking2.recordId), "Batch reject must prevent op3 mutation")
    }
