...
final class EncryptionSecurityTests: XCTestCase {
    ...
    func testEncryptionKeyDerivation() throws {
        ...
        let db3 = try BlazeDBClient(name: "Test", fileURL: tempURL, password: "CorrectPassword-123!")
    ...
    func testDifferentPasswordsDeriveDifferentKeys() throws {
        ...
        let db3 = try BlazeDBClient(name: "Test", fileURL: tempURL, password: "FirstPassword-ABC123!")
    ...
    func testEncryptionKeyPersistenceAcrossSessions() throws {
        ...
        do {
            let db = try BlazeDBClient(name: "Test", fileURL: tempURL, password: "SessionTest-123!")
    ...
    func testEncryptedDataUnreadableWithoutKey() throws {
        ...
        let db = try BlazeDBClient(name: "Test", fileURL: tempURL, password: "EncryptionTest-789!")
    ...
    func testDifferentPasswordsOnSameDatabase() throws {
        ...
        // Verify original password still works
        let db3 = try BlazeDBClient(name: "Test", fileURL: tempURL, password: "InitialPassword-123!")
    ...
    func testKeyDerivationWithLargerRecords() throws {
        ...
        let db = try BlazeDBClient(name: "Test", fileURL: tempURL, password: "LargeDataTest-123!")
    ...
    func testConcurrentAccessWithSamePassword() throws {
        ...
        let db = try BlazeDBClient(name: "Test", fileURL: tempURL, password: "ConcurrentTest-123!")
