...
final class RLSPolicyEngineTests: XCTestCase {
    ...
    func testPolicyEngine_ViewerReadOnly() {
        ...
        // viewerReadOnly is a restrictive policy that denies all ops for viewers.
        // viewerCanSelect is a permissive companion that grants select.
        engine.addPolicy(.viewerReadOnly())
        engine.addPolicy(.viewerCanSelect())
