...
final class UnifiedAPITests: XCTestCase {
    ...
    override func setUp() {
        ...
        db = try! BlazeDBClient(name: "unified_test_\(testID)", fileURL: tempURL, password: "SecureTestDB-456!")
    }
    ...
    func testJoinQuery_CanFlattenToRecords() throws {
        ...
        let usersDB = try BlazeDBClient(name: "users2", fileURL: usersURL, password: "SecureTestDB-456!")
