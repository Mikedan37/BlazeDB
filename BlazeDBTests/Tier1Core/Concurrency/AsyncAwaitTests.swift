...
final class AsyncAwaitTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        db = try BlazeDBClient(name: "async_test", fileURL: tempURL, password: "SecureTestDB-456!")
    ...
    func testAsyncQuery_WithJOIN() async throws {
        ...
        let usersDB = try BlazeDBClient(name: "users", fileURL: tempURL2, password: "SecureTestDB-456!")
