...
final class PersistenceIntegrityTests: XCTestCase {
    ...
    override func setUp() {
        ...
        db = try! BlazeDBClient(name: "persist_test", fileURL: tempURL, password: "SecureTestDB-456!")
    }
    ...
    func testSingleRecordPersistence() throws {
        ...
        XCTAssertEqual(try db.count(), 1, "Should have exactly 1 record")
    ...
    func testTenRecordsPersistence() throws {
        ...
        let countAfterReopen = try db.count()
    ...
    func test100RecordsPersistence() throws {
        ...
        XCTAssertEqual(try db.count(), 100, "Should have exactly 100 records")
    ...
    func testMultiplePersistCycles() throws {
        ...
        XCTAssertEqual(try db.count(), 15, "Should have 15 records after 3 cycles")
        ...
        XCTAssertEqual(try db.count(), 15, "Should have all 15 records after reopen")
    ...
    func testPersistEmptyDatabase() throws {
        ...
        XCTAssertEqual(try db.count(), 0, "Empty database should remain empty")
    }
    ...
    func testPersistInsertPersistCycle() throws {
        ...
        try db.persist()
        XCTAssertEqual(try db.count(), 10)
        ...
        XCTAssertEqual(try db.count(), 10, "Should have all 10 records")
    ...
    func testLargeDatasetPersistence() throws {
        ...
        XCTAssertEqual(try db.count(), recordCount, "Should have all \(recordCount) records")
    ...
    func testDeletesPersist() throws {
        ...
        XCTAssertEqual(try db.count(), 2, "Should have 2 records after delete")
