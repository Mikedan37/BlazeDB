...
final class AutoMigrationVerificationTests: XCTestCase {
    ...
    override func setUp() {
        ...
        db = try! BlazeDBClient(name: "migration_test", fileURL: tempURL, password: "SecureTestDB-456!")
    ...
    func testMigrationDoesntCorruptMetadata() throws {
        ...
        XCTAssertEqual(try db.count(), 10, "All records should survive migration check")
    }
    ...
    func testMigrationFailurePreservesData() throws {
        ...
        XCTAssertEqual(try db.count(), 10, "Data should survive migration")
