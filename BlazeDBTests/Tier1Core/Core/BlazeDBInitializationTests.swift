...
final class BlazeDBInitializationTests: XCTestCase {
    ...
    func testFailableInit_Success() throws {
        ...
        var db: BlazeDBClient? = BlazeDBClient(name: "TestDB", at: tempURL, password: "SecurePassword-123!")
    ...
    func testFailableInit_MinimumValidPassword() throws {
        ...
        var db: BlazeDBClient? = BlazeDBClient(name: "TestDB", at: tempURL, password: "MinPass-12AB!")
    ...
    func testConvenienceInit_Throwing() throws {
        ...
        var db: BlazeDBClient? = try BlazeDBClient(name: "TestDB", fileURL: tempURL, password: "SecurePassword-123!")
    ...
    func testRealWorld_ErrorRecovery() throws {
        ...
        db = BlazeDBClient(name: "TestDB", at: tempURL, password: "StrongPassword-123!")
