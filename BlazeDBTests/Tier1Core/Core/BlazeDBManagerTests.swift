...
final class BlazeDBManagerTests: XCTestCase {
    ...
    func testListMountedDatabases() throws {
        ...
        try manager.mountDatabase(named: dbName, fileURL: url, password: "SecurePass-123!")
    ...
    func testThreeDatabasesSimultaneous() throws {
        ...
        try manager.mountDatabase(named: "DB1", fileURL: db1URL, password: "SecurePass-001!")
        try manager.mountDatabase(named: "DB2", fileURL: db2URL, password: "SecurePass-002!")
        try manager.mountDatabase(named: "DB3", fileURL: db3URL, password: "SecurePass-003!")
    ...
    func testUnmountCleansUpResources() throws {
        ...
        try manager.mountDatabase(named: "CleanupTest", fileURL: dbURL, password: "SecurePass-123!")
        XCTAssertEqual(manager.mountedDatabaseNames.count, 1)
    ...
    func testSwitchDatabaseUnderLoad() throws {
        ...
        try manager.mountDatabase(named: "SwitchDB1", fileURL: db1URL, password: "SecurePass-001!")
        try manager.mountDatabase(named: "SwitchDB2", fileURL: db2URL, password: "SecurePass-002!")
    ...
    func testDatabaseMemoryIsolation() throws {
        ...
        try manager.mountDatabase(named: "IsolateDB1", fileURL: db1URL, password: "SecurePass-001!")
        try manager.mountDatabase(named: "IsolateDB2", fileURL: db2URL, password: "SecurePass-002!")
    ...
    func testMountCorruptedDatabaseFails() throws {
        ...
        do {
            let db = try manager.mountDatabase(named: "CorruptDB", fileURL: corruptURL, password: "SecurePass-123!")
    ...
    func testUnmountAllDatabases() throws {
        ...
        for (i, url) in urls.enumerated() {
            try manager.mountDatabase(named: "DB\(i)", fileURL: url, password: "SecurePass-\(String(format: "%03d", i))!")
        }
