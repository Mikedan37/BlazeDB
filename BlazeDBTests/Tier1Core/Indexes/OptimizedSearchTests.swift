...
final class OptimizedSearchTests: XCTestCase {
    ...
    override func setUp() {
        ...
        db = try! BlazeDBClient(name: "OptSearchTest_\(testID)", fileURL: tempURL, password: "SecureTestDB-456!")
    }
    ...
    func testIndexPersistence() throws {
        ...
        db = try! BlazeDBClient(name: "OptSearchTest_Reopened", fileURL: dbURL, password: "SecureTestDB-456!")
