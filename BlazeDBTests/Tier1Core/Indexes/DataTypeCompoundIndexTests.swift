...
final class DataTypeCompoundIndexTests: XCTestCase {
    ...
    override func setUp() {
        ...
        db = try! BlazeDBClient(name: "DataIdxTest_\(testID)", fileURL: tempURL, password: "SecureTestDB-456!")
    }
    ...
    func testDataInCompoundIndexPersistence() throws {
        ...
        db = try! BlazeDBClient(name: dbName, fileURL: tempURL, password: "SecureTestDB-456!")
