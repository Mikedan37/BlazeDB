...
- ⚠️ **Needs Review:** 3 (legacy code, TODOs, deprecated methods)
...
2. ⚠️ **Review:** Verify `BlazeQueryLegacy` usage - deprecate or rename
3. ⚠️ **Document:** Add TODOs to project tracking or implement
4. ⚠️ **Cleanup:** Remove deprecated async methods if unused
