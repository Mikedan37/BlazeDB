...
_Auto-generated by `Scripts/run_core_benchmark_matrix.py` on 2026-03-14T09:03:18+00:00._
...
|---|---|---|---|---|---:|
| baseline | on | on | on | pass | 856.991 |
| mvcc_off | off | on | on | pass | 765.132 |
| wal_off_requested | on | off | on | unavailable | 0.000 |
| encryption_off_requested | on | on | off | pass | 867.581 |
