...
_Auto-generated by `Scripts/run_core_benchmark_matrix.py` on 2026-03-14T08:12:49+00:00._
...
|---|---|---|---|---|---:|
| baseline | on | on | on | pass | 848.987 |
| mvcc_off | off | on | on | pass | 748.413 |
| wal_off_requested | on | off | on | unavailable | 0.000 |
| encryption_off_requested | on | on | off | unavailable | 0.000 |
| mvcc_off_wal_off_enc_off_requested | off | off | off | unavailable | 0.000 |
