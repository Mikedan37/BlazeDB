...
Start with the default shipped core story first:

- [Repository README](../../README.md) (product scope and quickstart)
- [Getting Started](../GettingStarted/README.md) (typed-first onboarding)
